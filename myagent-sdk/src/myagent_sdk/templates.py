...
def create_plugin(
    ...
    """Scaffold a minimal MyAgent plugin project at ``target_dir``.
    ...
    distribution_name = f"myagent-{plugin_name.lower()}"
    ...
    mapping = {
        ...
        "description": description or f"MyAgent plugin: {plugin_name}",
        "repository_url": repository_url or "https://gitcode.com/badhope/myagent",
    }
    ...
    for dest_name, template_name in files.items():
        ...
        if template_name is None:
            dest.write_text('"""MyAgent plugin package."""\n')
        else:
