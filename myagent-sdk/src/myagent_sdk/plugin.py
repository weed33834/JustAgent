"""Base classes and decorators for MyAgent plugins."""
...
class Plugin:
    """Base class for MyAgent plugins.
    ...
    def register(self, dispatcher: Any) -> None:
        ...
        Args:
            dispatcher: An object with a ``register`` method, such as
                :class:`myagent.core.hook_dispatcher.HookDispatcher`.
        """
...
def hook(func: Callable[..., Any]) -> Callable[..., Any]:
    ...
    This is a thin wrapper around ``myagent.hookspec.hookimpl`` that can be
