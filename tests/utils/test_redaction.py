"""Tests for the path-redaction helper in ``justagent.utils.redaction``."""
...
from justagent.utils.redaction import redact_paths
...
def test_redact_paths_replaces_home_prefix_with_tilde(tmp_path: Path) -> None:
    ...
    with patch("justagent.utils.redaction.Path.home", return_value=fake_home):
