...
from justagent.plugins.typecheck import TypecheckPlugin
...
def test_pre_commit_skips_when_pyright_missing(
    ...
    with patch("justagent.plugins.typecheck._tool_executable", return_value=None):
...
def test_pre_commit_passes_when_pyright_succeeds(
    ...
    mock_result.stderr = ""
    with (
        patch("justagent.plugins.typecheck._tool_executable", return_value="/usr/bin/pyright"),
