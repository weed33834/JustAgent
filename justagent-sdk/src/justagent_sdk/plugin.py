"""Base classes and decorators for JustAgent plugins."""
...
class Plugin:
    """Base class for JustAgent plugins.
    ...
    def register(self, dispatcher: Any) -> None:
        ...
        Args:
            dispatcher: An object with a ``register`` method, such as
                :class:`justagent.core.hook_dispatcher.HookDispatcher`.
        """
...
def hook(func: Callable[..., Any]) -> Callable[..., Any]:
    ...
    This is a thin wrapper around ``justagent.hookspec.hookimpl`` that can be
