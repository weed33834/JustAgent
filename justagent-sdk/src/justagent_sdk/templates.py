...
def create_plugin(
    ...
    """Scaffold a minimal JustAgent plugin project at ``target_dir``.
    ...
    distribution_name = f"justagent-{plugin_name.lower()}"
    ...
    mapping = {
        ...
        "description": description or f"JustAgent plugin: {plugin_name}",
        "repository_url": repository_url or "https://gitcode.com/badhope/justagent",
    }
    ...
    for dest_name, template_name in files.items():
        ...
        if template_name is None:
            dest.write_text('"""JustAgent plugin package."""\n')
        else:
