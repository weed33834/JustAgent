...
* :class:`LLMClient` is a thin wrapper around LiteLLM that supports
  ...
  :class:`justagent.adapters.model_gateway.ModelGateway` because that
...
* Abort is via :class:`asyncio.Event` (matching
  :class:`justagent.agent.tools.base.ToolContext.abort`).
...
class LLMClient:
    ...
    Decoupled from :class:`justagent.adapters.model_gateway.ModelGateway`
