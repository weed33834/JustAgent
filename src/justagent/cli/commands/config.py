"""``justagent config`` command: inspect and manage configuration."""
...
from justagent.utils.redaction import is_sensitive_key

app = typer.Typer(
    name="config",
    help="Inspect and manage JustAgent configuration.",
