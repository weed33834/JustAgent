"""The ``justagent artifacts`` command: language-aware build output removal.
...
Rules live in :mod:`justagent.core.language_rules`; this command is a thin
...
Examples::
    ...
    justagent artifacts --dry-run       # show what would be removed
    justagent artifacts                 # remove build outputs
    justagent artifacts --list          # show which rules apply, no scanning
    justagent artifacts --language go   # restrict to one language
"""
