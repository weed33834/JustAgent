...
:mod:`justagent.orchestration.mesh` so that capability taxonomies are shared
...
from justagent.orchestration.mesh import AgentCapability

logger = logging.getLogger("justagent.orchestration.coordinator")
