...
vector store (:mod:`justagent.knowledge.vector`) with the model gateway
(:mod:`justagent.adapters.model_gateway`) for LLM-based answer synthesis.

The pipeline:

1. **Ingest** — a :class:`~justagent.knowledge.document.Document` is
