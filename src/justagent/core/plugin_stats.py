...
Stats are stored locally in ``~/.config/justagent/plugin_stats.json`` and never
...
from justagent.utils.json_io import load_json, save_json

if TYPE_CHECKING:
    from justagent.core.telemetry import TelemetryCollector

logger = logging.getLogger("justagent")

DEFAULT_STATS_DIR = Path.home() / ".config" / "justagent"
