...
Extends the base :class:`~myagent.permissions.PermissionEngine` with
...
logger = logging.getLogger("myagent.permissions.enterprise")
...
class EnterprisePermissionEngine:
    ...
    Example::
        ...
        from myagent.permissions import PermissionAction
...
def create_enterprise_engine(
    ...
    * Asks for allocation of CRITICAL resources by non-admins.
    ...
    from myagent.permissions import create_act_mode_engine
