...
from myagent.utils.hashing import compute_sha256, pip_cmd
...
def download_and_verify(
    ...
    *,
    ...
    """
    with tempfile.TemporaryDirectory(prefix="myagent-pkg-") as tmp:
        tmp_path = Path(tmp)
        ...
        if dest_dir is not None:
            ...
            final_dir = Path(tempfile.mkdtemp(prefix="myagent-pkg-"))
