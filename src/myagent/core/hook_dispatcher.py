...
from myagent.core.plugin_registry import PluginRegistry, TrustLevel
from myagent.core.sandbox import SandboxRunner
from myagent.exceptions import PluginError
from myagent.hookspec import MyAgentHookSpec
...
class HookDispatcher:
    ...
    def __init__(
        ...
        self.pm = pluggy.PluginManager("myagent")
    ...
    def _load_builtin(self) -> None:
        ...
        for mod_name in builtin_modules:
            try:
                mod = import_module(f"myagent.plugins.{mod_name}")
    ...
    def _call_in_sandbox(
        ...
        try:
            # Preserve PYTHONPATH so the subprocess can find myagent and installed plugins.
            env_whitelist = [
                "PATH",
                "HOME",
                "USER",
