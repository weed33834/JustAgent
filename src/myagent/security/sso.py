...
Provides enterprise identity federation for the Omniagent platform.
Users authenticate once against an external identity provider (IdP) and
receive a platform :class:`~myagent.security.rbac.User` session.
...
from myagent.security.rbac import User, UserStatus

logger = logging.getLogger("myagent.security.sso")
