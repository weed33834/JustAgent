"""``myagent plugin`` command: install, uninstall, list, search, info, rate, stats, update, trust."""
...
from myagent.core.package_verifier import PackageVerificationError, download_and_verify
from myagent.core.plugin_registry import CapabilityManifest, PluginRegistry, PluginSpec, TrustLevel
from myagent.core.plugin_stats import PluginStats
