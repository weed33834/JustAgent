...
from myagent.utils.patch import apply_patch, patch_paths_are_safe
...
ERROR_LOG_DIR = Path.home() / ".local" / "state" / "myagent"
...
# public surface so ``myagent lsp`` can import it without a
...
def _apply_patch(
    ...
    :func:`myagent.utils.patch.apply_patch` so the logic is shared with the
