"""The ``myagent fix`` command — LLM-powered fix proposal."""
...
from myagent.utils.redaction import redact_paths, redact_text

app = typer.Typer()

ERROR_LOG_PATH = Path.home() / ".local" / "state" / "myagent" / "last_error.txt"
