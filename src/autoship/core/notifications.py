...
class NotificationError(AutoShipError):
...
class DesktopChannel:
    ...
    def send(self, notification: Notification) -> None:
        try:
            ...
            print(
                f"[autoship] desktop notification failed: {exc}",
                file=sys.stderr,
            )
...
class WebhookChannel:
    ...
    def send(self, notification: Notification) -> None:
        ...
        try:
            ...
            print(
                f"[autoship] webhook notification failed: {exc}",
                file=sys.stderr,
            )
...
class LogChannel:
    ...
    def send(self, notification: Notification) -> None:
        ...
        try:
            ...
            print(
                f"[autoship] log notification failed: {exc}",
                file=sys.stderr,
            )
